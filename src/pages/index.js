      ...
      <div className="rounded-lg h-full relative flex flex-row flex-wrap overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full bg-opacity-60 bg-[#000000] grid place-items-center text-white">
          <div className="grid place-items-center">
            ...
            >
              Explore
                <svg xmlns="http://www.w3.org/2000/svg" className="absolute opacity-0 transition-opacity ease-in-out right-5 top-0 animate-bounce-x-4 group-hover:opacity-100 h-full py-2" viewBox="0 0 448 512">

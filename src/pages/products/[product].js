...
export default function ProductDetail({ product }) {
  ...
  return (
    <>
      ...
      <div className="bg-bgWhite min-h-full flex flex-col gap-x-10 rounded-lg">
        ...
        <div className="bg-white w-full min-h-full py-5 px-4 md:px-20">
          <h2 className="font-bold text-center text-6xl font-utsaah">
            {product.name}
          </h2>
          <div className="flex flex-col gap-y-5 justify-between min-h-[70%] py-[5%]">
            <div className="flex flex-col justify-between md:flex-row gap-x-10">
              ...
              <div className="md:w-[40%] min-h-full bg-white shadow-2xl rounded-xl">
